...
const PostRow = ( {id, image_path, title, tags, upvotes} ) => {

    // format for rendering posts in row format
    ...
    return (
        <div className="post-row">
            ...
            <div className="post-row-sec">
                ...
                <img src={currentImg ? (currentImg) : 'https://placehold.jp/150x100.png'} alt='picture' width={150} height={100} className='image-cls'/>
                    <h3> {title} </h3>
                    <div className="tag-cntr">
                        {tags ? (tags.map((tag) => (
            ...
            <div className="dropdown">
                    ...
                    <div className={`extd-content row-special ${toggle ? 'show' : ''}`}>
                        <Link to={`/update/${id}`}>
                            update post! ✐ᝰ
                        </Link>
